...
namespace Neetcode150
{
    public class DpOneNeet
    {
        ...
        */
        ...
        A option leads to not being able to rob the previous house i - 1
        which leads to getting all the loot from i - 2 and proceeding ones.
        
        B option leads to being able to rob the previous house i - 2
        which leads to not getting to loot from i - 1 and proceeding ones.

        These options boil down to:
        -Robbery of current house and loot before the previous one (i - 2)(Option A)
        -Robbery of the previous house(i - 1) and any loot before that one.(Option B)

        rob(i) = Math.Max(rob(i - 2) + currentHouseValue, rob(i - 1))
        this would invoked as: rob(nums, nums.length - 1)

        Iterative solution evolution with some explanations:
        ...
        */
        ...
        s = "89232965" Expected = 2
        s = "593818373622381611833752119229471015744421214122547" Expected = 28800
        s = "838643278928185583910645710666865441425164710327259817829115931764226422141243163106881875199363310" Expected = 138240
        s = "3211861694771819158316535961873532154764575381592125971257835934686994916716779194217161210188158941" Expected = 11059200
