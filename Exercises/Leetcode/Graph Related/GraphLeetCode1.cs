...
namespace Exercises.Leetcode.GraphRelated
{
    public class GraphLeetcode1
    {
        #region Find Eventual Safe States (Medium)
        ...
        meaning there is an edge from node i to each node in graph[i]. A node is a terminal node if there are no outgoing edges. 
